...
Single seed on all reported arms; a noise-floor measurement at three seeds of
the reference configuration is in progress and is the correct denominator for
every comparison above. Single corpus, single backbone family. No comparison
